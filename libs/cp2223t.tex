...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{f2}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f2}\;\Varid{n}\mathrel{=}(\Varid{a}\mathbin{*}\Varid{f2}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{+}(\Varid{b}\mathbin{*}\Varid{f1}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{+}(\Varid{c}\mathbin{*}\Varid{f'}\;(\Varid{n}\mathbin{-}\mathrm{1})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f1}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f1}\;\Varid{n}\mathrel{=}\Varid{f2}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f'}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{f'}\;\Varid{n}\mathrel{=}\Varid{f1}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
