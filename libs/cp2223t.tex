...
\\
\>[B]{}\Varid{fib}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{f}\;\Varid{nb}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{f2}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{f2}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{a}\mathbin{*}(\Varid{f2}\;\Varid{a}\;\Varid{b}\;\Varid{c})\;\Varid{n}\mathbin{+}\Varid{b}\mathbin{*}(\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c})\;\Varid{n}\mathbin{+}\Varid{c}\mathbin{*}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{f2}\;\Varid{a}\;\Varid{b}\;\Varid{c})\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c})\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{f2}\;\anonymous \;\anonymous \;\anonymous \;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f2}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\Varid{n}\mathrel{=}(\Varid{x}\mathbin{*}\Varid{f2}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{+}(\Varid{y}\mathbin{*}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{+}(\Varid{z}\mathbin{*}\Varid{fn}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\mathrm{1})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f1}\;\anonymous \;\anonymous \;\anonymous \;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\Varid{n}\mathrel{=}\Varid{f2}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{fn}\;\anonymous \;\anonymous \;\anonymous \;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{fn}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\Varid{n}\mathrel{=}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Com estas funções \ensuremath{\Varid{f1}}, \ensuremath{\Varid{f2}} e \ensuremath{\Varid{fn}}, conseguimos usar a lei da recursividade mútua e formar 
as seguintes funções auxiliares através da regra prática presente no anexo \ref{sec:mr}:

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{f2},\Varid{f1}),\Varid{fn})\mathrel{=}((\Varid{a}\mathbin{*}\Varid{f2}\mathbin{+}\Varid{b}\mathbin{*}\Varid{f1}\mathbin{+}\Varid{c}\mathbin{*}\Varid{fn},\Varid{f2}),\Varid{f1}){}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{out}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{String}+(\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{out}\;[\mskip1.5mu \Varid{s}\mskip1.5mu]\mathrel{=}i_1\;\Varid{s}{}\<[E]%
\\
\>[B]{}\Varid{out}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{h},\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gene}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{String}+(\Conid{String},[\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{gene}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;\text{\ttfamily \char34 \char34}{}\<[E]%
\\
\>[B]{}\Varid{gene}\;\Varid{l}\mathrel{=}((\Varid{id}+\Varid{id}\times\Varid{aux})\comp (\Varid{\Conid{Main}.out}))\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{getLevel}\mathrel{=}(\Varid{flip}\;\cdot \div \cdot \;\mathrm{4})\comp \length \comp (\Varid{takeWhile}\;(\equiv \text{\ttfamily '~'})){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{upLevel}\mathrel{=}\map \;(\Varid{drop}\;\mathrm{4}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\mathrel{=}\anaList{\Varid{g}}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{g}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{g}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{let}\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{span}\;((\mathbin{>}\mathrm{1})\comp \Varid{getLevel})\;\Varid{t}\;\mathbf{in}\;i_2\;(\Varid{upLevel}\;(\Varid{h}\mathbin{:}\Varid{x}),\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{post}\;(\Conid{Var}\;\Varid{v})\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{v}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{post}\;(\Conid{Term}\;\Varid{v}\;[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{v}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{post}\;(\Conid{Term}\;\Varid{x}\;\Varid{children})\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathbin{:}\Varid{concatMap}\;(\lambda \Varid{y}\to \map \;(\Varid{x}\mathbin{:})\;(\Varid{post}\;\Varid{y}))\;\Varid{children}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\subsection*{Problema 3}
Função \ensuremath{\Varid{squares}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\ColumnHook
\end{hscode}\resethooks
A função \ensuremath{\Varid{gsq}} é muito simples. Ela gera a raíz da árvore, ou seja, o quadrado central e gera os quadrados 
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gsq}\;(((\Varid{x},\Varid{y}),\Varid{l}),\mathrm{0})\mathrel{=}\mathbf{let}\;\Varid{c}\mathrel{=}\Varid{l}\mathbin{/}\mathrm{3}\;\mathbf{in}\;(((\Varid{x}\mathbin{+}\Varid{c},\Varid{y}\mathbin{+}\Varid{c}),\Varid{c}),[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{gsq}\;(((\Varid{x},\Varid{y}),\Varid{l}),\Varid{n})\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{c},\Varid{y}\mathbin{+}\Varid{c}),\Varid{c}),\Varid{nexts}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{c}\mathrel{=}\Varid{l}\mathbin{/}\mathrm{3}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{nexts}\mathrel{=}[\mskip1.5mu (((\Varid{x},\Varid{y}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{c}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(((\Varid{x},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{c}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(((\Varid{x}\mathbin{+}\Varid{c},\Varid{y}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(((\Varid{x}\mathbin{+}\Varid{c},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{c}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{c},\Varid{y}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{c},\Varid{y}\mathbin{+}\Varid{c}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{c},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{c}),\Varid{c}),\Varid{n}\mathbin{-}\mathrm{1})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\ColumnHook
\end{hscode}\resethooks
A função \ensuremath{\Varid{carpets}} gera uma lista de listas de quadrados em que cada lista contém os quadrados do nível
\ensuremath{\mathrm{0}} até ao nível \ensuremath{\Varid{n}\mathbin{-}\mathrm{1}}. Cada lista é gerada a partir da função \ensuremath{\Varid{sierpinski}} que recebe um 
quadrado com coordenadas \ensuremath{(\mathrm{0},\mathrm{0})} e lado 32.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{carpets}\;\Varid{n}\mathrel{=}[\mskip1.5mu \Varid{sierpinski}\;(((\mathrm{0},\mathrm{0}),\mathrm{32}),\Varid{i})\mid \Varid{i}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\Varid{n}\mathbin{-}\mathrm{1}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A função \ensuremath{\Varid{present}} é muito simples. Ela recebe várias listas de quadrados, em que cada lista 
tem os quadrados de um certo nível da RoseTree e imprime esses quadrados através da função \ensuremath{\Varid{drawSq}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\Varid{present}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{drawSq}\;\Varid{x};{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{await};{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{present}\;\Varid{xs};{}\<[E]%
\\
\>[B]{}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\subsection*{Problema 4}
\subsubsection*{Versão não probabilística}
A função \ensuremath{\Varid{cgene}}, no caso em que recebe um par \ensuremath{((\Conid{Team},\Conid{Int}),[\mskip1.5mu (\Conid{Team},\Conid{Int})\mskip1.5mu])} (em que Int representa os pontos
da equipa). A função começa por reconstruir a lista adicionando o par \ensuremath{(\Conid{Team},\Conid{Int})} à lista do segundo 
...
\ensuremath{\Varid{gr}}. Após agrupar os diversos pares pela respetiva equipa, somámos os pontos para obter a pontuação
total da equipa. Para isso utilizámos a função \ensuremath{\Varid{soma}}.
...
\\
\>[B]{}\Varid{cgene}\mathrel{=}\alt{\Varid{nil}}{(\map \;\Varid{soma})\comp \Varid{gr}\comp \Varid{cons}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{gr}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{gr}\;\Varid{l}\mathord{@}((\Varid{t},\anonymous )\mathbin{:\char95 })\mathrel{=}\Varid{filter}\;((\equiv \Varid{t})\comp \p1)\;\Varid{l}\mathbin{:}\Varid{gr}\;(\Varid{filter}\;((\not\equiv \Varid{t})\comp \p1)\;\Varid{l}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{soma}\;\Varid{l}\mathord{@}((\Varid{x},\anonymous )\mathbin{:}\Varid{t})\mathrel{=}(\Varid{x},\Varid{sum}\;(\map \;\p2\;\Varid{l})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A função \ensuremath{\Varid{pairup}} irá gerar todos os jogos da fase de grupos de um certo grupo.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\Varid{pairup}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}[\mskip1.5mu (\Varid{h},\Varid{x})\mid \Varid{x}\leftarrow \Varid{t}\mskip1.5mu]\mathbin{+\!\!\!+}\Varid{pairup}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A função \ensuremath{\Varid{matchResult}} utiliza uma função de critério para avaliar o resultado de um certo jogo.
A função de critério devolve o nome da equipa vencedora ou \ensuremath{\Conid{Nothing}} em caso de empate. Assim,
com o resultado da função de critério, a \ensuremath{\Varid{matchResult}} devolverá sempre uma lista com dois pares
...
\\
\>[B]{}\Varid{matchResult}\;\Varid{f}\;\Varid{m}\mathord{@}(\Varid{eq1},\Varid{eq2})\mathrel{=}{}\<[30]%
\>[30]{}\mathbf{let}\;\Varid{res}\mathrel{=}\Varid{f}\;\Varid{m};{}\<[E]%
\\
\>[30]{}\hsindent{4}{}\<[34]%
\>[34]{}\Varid{eq1\char95 pts}\mathrel{=}\mathbf{if}\;\Varid{res}\equiv \Conid{Nothing}\;\mathbf{then}\;\mathrm{1}{}\<[E]%
\\
\>[34]{}\hsindent{10}{}\<[44]%
\>[44]{}\mathbf{else}\;\mathbf{if}\;\Varid{res}\equiv \Conid{Just}\;\Varid{eq1}\;\mathbf{then}\;\mathrm{3}{}\<[E]%
\\
\>[34]{}\hsindent{10}{}\<[44]%
\>[44]{}\mathbf{else}\;\mathrm{0};{}\<[E]%
\\
\>[30]{}\hsindent{4}{}\<[34]%
\>[34]{}\Varid{eq2\char95 pts}\mathrel{=}\mathbf{if}\;\Varid{res}\equiv \Conid{Nothing}\;\mathbf{then}\;\mathrm{1}{}\<[E]%
\\
\>[34]{}\hsindent{10}{}\<[44]%
\>[44]{}\mathbf{else}\;\mathbf{if}\;\Varid{res}\equiv \Conid{Just}\;\Varid{eq2}\;\mathbf{then}\;\mathrm{3}{}\<[E]%
\\
\>[34]{}\hsindent{10}{}\<[44]%
\>[44]{}\mathbf{else}\;\mathrm{0};{}\<[E]%
\\
\>[30]{}\hsindent{1}{}\<[31]%
\>[31]{}\mathbf{in}\;[\mskip1.5mu (\Varid{eq1},\Varid{eq1\char95 pts}),(\Varid{eq2},\Varid{eq2\char95 pts})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A função \ensuremath{\Varid{glt}} serve para a construção da LTree. Assim, caso receba uma lista singular, apenas retorna o
...
\\
\>[B]{}\Varid{glt}\;\Varid{l}\mathrel{=}\mathbf{let}\;\Varid{len}\mathrel{=}\length \;\Varid{l}\div \mathrm{2}\;\mathbf{in}\;i_2\;(\Varid{splitAt}\;\Varid{len}\;\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection*{Versão probabilística}
A função \ensuremath{\Varid{pinitKnockoutStage}} é muito simples. Ela apenas usa a função \ensuremath{\Varid{initKnockoutStage}} da versão não
probabilística para gerar a LTree e coloca essa árvore no monad Dist.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pinitKnockoutStage}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{Team}\mskip1.5mu]\mskip1.5mu]\to \fun{Dist}\;({\LTree}\;\Conid{Team}){}\<[E]%
\\
\>[B]{}\Varid{pinitKnockoutStage}\mathrel{=}\Varid{return}\comp \Varid{initKnockoutStage}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Na função \ensuremath{\Varid{pgroupWinners}}, começámos por gerar todas as combinações de resultados de jogos em 
...
tratamento \ensuremath{(\Varid{best}\;\mathrm{2})\comp \Varid{consolidate}} (como na \ensuremath{\Varid{groupWinners}} da versão não probabilística). Depois, 
...
\\
\>[B]{}\Varid{pgroupWinners}\;\Varid{crit}\;\Varid{m}\mathrel{=}\Conid{D}\mathbin{\$}\map \;(((\Varid{best}\;\mathrm{2})\comp \Varid{consolidate}\comp \Varid{concat})\times\Varid{id})\;\Varid{no\char95 monad\char95 combs}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\mathrel{=}\map \;(\Varid{pmatchResult}\;\Varid{crit})\;\Varid{m};{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{combs}\mathrel{=}\Varid{sequence}\;\Varid{aux};{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{no\char95 monad\char95 combs}\mathrel{=}(\lambda (\Conid{D}\;\Varid{k})\to \Varid{k})\;\Varid{combs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A função \ensuremath{\Varid{pmatchResult}} calcula as possbilidades do resultado de um jogo, isto é, retorna as probabilidades
...
\\
\>[B]{}\Varid{pmatchResult}\;\Varid{f}\;\Varid{m}\mathord{@}(e_1 ,e_2 )\mathrel{=}\Conid{D}\;(\Varid{empate}\mathbin{+\!\!\!+}\Varid{e1\char95 }\mathbin{+\!\!\!+}\Varid{e2\char95 }){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{criteria}\mathrel{=}(\lambda (\Conid{D}\;\Varid{x})\to \Varid{x})\;(\Varid{f}\;\Varid{m}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{maybe\char95 prob\char95 empate}\mathrel{=}\Varid{\Conid{List}.lookup}\;\Conid{Nothing}\;\Varid{criteria}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{maybe\char95 prob\char95 e1}\mathrel{=}\Varid{\Conid{List}.lookup}\;(\Conid{Just}\;e_1 )\;\Varid{criteria}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{maybe\char95 prob\char95 e2}\mathrel{=}\Varid{\Conid{List}.lookup}\;(\Conid{Just}\;e_2 )\;\Varid{criteria}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{empate}\mathrel{=}\mathbf{if}\;\Varid{maybe\char95 prob\char95 empate}\equiv \Conid{Nothing}\;\mathbf{then}\;[\mskip1.5mu \mskip1.5mu]\;\mathbf{else}\;[\mskip1.5mu ([\mskip1.5mu (e_1 ,\mathrm{1}),(e_2 ,\mathrm{1})\mskip1.5mu],(\lambda (\Conid{Just}\;\Varid{x})\to \Varid{x})\;\Varid{maybe\char95 prob\char95 empate})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{e1\char95 }\mathrel{=}\mathbf{if}\;\Varid{maybe\char95 prob\char95 e1}\equiv \Conid{Nothing}\;\mathbf{then}\;[\mskip1.5mu \mskip1.5mu]\;\mathbf{else}\;[\mskip1.5mu ([\mskip1.5mu (e_1 ,\mathrm{3}),(e_2 ,\mathrm{0})\mskip1.5mu],(\lambda (\Conid{Just}\;\Varid{x})\to \Varid{x})\;\Varid{maybe\char95 prob\char95 e1})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{e2\char95 }\mathrel{=}\mathbf{if}\;\Varid{maybe\char95 prob\char95 e2}\equiv \Conid{Nothing}\;\mathbf{then}\;[\mskip1.5mu \mskip1.5mu]\;\mathbf{else}\;[\mskip1.5mu ([\mskip1.5mu (e_1 ,\mathrm{0}),(e_2 ,\mathrm{3})\mskip1.5mu],(\lambda (\Conid{Just}\;\Varid{x})\to \Varid{x})\;\Varid{maybe\char95 prob\char95 e2})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
